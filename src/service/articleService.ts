...
export interface ArticleService {
   ...
   * @description Get author from an article from the database with relations
   ...
   * @description Get the feed in which an article was published from database with relations
   ...
   * @description Get the categories from the article from database with relations
   ...
   * @description Get the amount of categories from the article from database with relations
   ...
   * @description Get the number of users who bookmarked this article from database with relations
