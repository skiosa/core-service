...
export async function initDB() {
  ...
  // article1.title = "How installing linux made me gain 20lbs of muscle";
  ...
  // article1.url =
  //   "https://asciiflix.de/watch/814bd1ab-18a7-41f2-8b23-7feb2bab9de2";
  // article1.categories = categoryMock.filter(
  //   (c) => c.name === "News" || c.name === "Entertainment"
  // );
  // article1.author = authorMock.find((a) => a.name === "Gustavo");
  // article1.feed = feedMock.find((f) => f.name === "Asciiflix.de");
  // dataSource.getRepository(Article).save(article1);
